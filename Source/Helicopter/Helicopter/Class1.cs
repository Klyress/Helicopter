...
namespace RimWorld
{
    ...
    public class CompHeliCarrier : ThingComp, IThingHolder
    {
        ...
        private static List<CompHeliCarrier> tmpTransportersInGroup = new List<CompHeliCarrier>();
        ...
        public Thing FirstThingLeftToLoadInGroup
        {
            get
            {
                List<CompHeliCarrier> list = this.TransportersInGroup(this.parent.Map);
        ...
        public List<CompHeliCarrier> TransportersInGroup(Map map)
        {
        ...
        public bool CancelLoad(Map map)
        {
            ...
            List<CompHeliCarrier> list = this.TransportersInGroup(map);
            for (int i = 0; i < list.Count; i++)
            {
        ...
        {
            List<CompHeliCarrier> list = this.TransportersInGroup(this.Map);
